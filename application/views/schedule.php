        ...
        <div class="modal-content" style="width:800px; margin-left: -80px;">
            ...
            <div class="modal-body tab-content">                    
                <div class="tab-pane active" id="scheduleTab1">
                    <table id="data-schedules-grup" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                ...
                <div class="tab-pane" id="scheduleTab2">
                    <form id="form-schedule-update-grup">                        
                        <div class="form-group">
                            <label>Title</label>
                            <input type="hidden" name="id_schedule" class="form-control" value=""/>
                            <input type="hidden" name="id_anggota" class="form-control" value=""/>
                            <input type="text" name="judul" class="form-control" value=""/>
                        </div> 
                        <div class="form-group">
                            <label>Start</label>
