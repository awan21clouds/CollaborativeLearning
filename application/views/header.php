                            ...
                            <form class="navbar-form navbar-left" role="search">
                                <div class="form-group">                  
                                    <div class="input-group">
                                        <!--<input type="text" class="form-control" style="width:460%;" id="navbar-search-input" placeholder="Search"/>-->
                                    </div>
                                    <!-- /.input group -->
                                </div>
                                <!-- /.form group -->
...
<!--                                <li>
                                     Menu Toggle Button 
                                    <a href="<!?php echo base_url(); ?>grup/index?id_grup=<!?php echo $id_grup;?>">
                                ...
                                <li class="dropdown notifications-menu">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li>
                                            ...
                                            <ul class="menu" id="header-notifications">
...
<!--                                                <li> start notification 
                                                    <a href="#">
                                                        <i class="fa fa-envelope text-red"></i> 5 new members joined today
                                                    </a>
                                                </li>-->
                                                <!-- end notification -->
                                            </ul>
                                ...
                                <li class="dropdown user user-menu">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="user-header">
                                            ...
                                            <?php // if(empty($this->session->userdata('user')->src_image)){
//                                                echo '<img src="'.base_url().'assets/dist/img/default.png" class="img-circle" alt="User Image">';
//                                            }else{
//                                                echo '<img src="'.base_url().$this->session->userdata('user')->src_image.'" class="img-circle" alt="User Image">';
//                                            }?>
