...
<html>
    <head>
        ...
        <link href="<?php echo base_url(); ?>assets/plugins/notify/animate.css" rel="stylesheet"/>
        <!-- FontAwesome 4.3.0 -->
                ...
                <nav class="navbar navbar-inverse navbar-fixed-top">
                    <div class="container">
                        <div class="navbar-header">
                            <a href="beranda" class="navbar-brand">Collaborative Learning</a>
                            ...
                            <form class="navbar-form navbar-left" role="search">
                                <div class="form-group">                  
                                    <div class="input-group">
                                        <input type="text" class="form-control" style="width:420%;" id="navbar-search-input" placeholder="Search"/>
                                    </div>
                                    <!-- /.input group -->
                                </div>
                                <!-- /.form group -->
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown user user-menu">
                                    ...
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                        ...
                                        <span class="hidden-xs"><?php echo explode(" ", $this->session->userdata('user')->nama)[0]; ?></span>
